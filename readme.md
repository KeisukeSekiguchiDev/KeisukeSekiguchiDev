<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=2E9EF7&center=true&vCenter=true&width=435&lines=AI-Native+Developer;DX+Project+Leader;Full+Stack+Engineer" alt="Typing SVG" />
</div>
...
- 🎯 **DXプロジェクト成功**: Excel業務の70%削減を達成
- 🚀 **AI活用実績**: Claude Codeで開発速度3倍を実現
- 📝 **技術発信**: Qiita月間トレンド入り（目標）
- 🌟 **OSS貢献**: 複数プロジェクトへのコントリビュート（進行中）
